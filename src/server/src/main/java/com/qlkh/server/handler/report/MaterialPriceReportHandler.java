...
import com.qlkh.core.client.action.report.MaterialPriceReportAction;
import com.qlkh.core.client.action.report.MaterialPriceReportResult;
 ...
 */
public class MaterialPriceReportHandler extends AbstractHandler<MaterialPriceReportAction, MaterialPriceReportResult> {
    ...
    @Override
    public Class<MaterialPriceReportAction> getActionType() {
        return MaterialPriceReportAction.class;
    }

    @Override
    public MaterialPriceReportResult execute(MaterialPriceReportAction action, ExecutionContext context) throws DispatchException {
        ...
        try {
            ...
            List<Material> materials = sqlQueryDao.getMaterialPrices(action.getYear(), action.getQuarter());
            ...
            return new MaterialPriceReportResult(fileUrl);
        ...
        return new MaterialPriceReportResult();
    }

    private DynamicReport buildReportLayout(MaterialPriceReportAction action) {
