 ...
 * <p/>
 * - [florin] - added support for utf-8 character encoding, gzip and for obtaining
 * a better performance. Added log4j support
 * <p/>
 * =================================================================
    ...
    public static void close(InputStream s) {
        if (s != null) {
            try {
                ...
                debug("Error closing stream: " + e.getMessage());
            }
        }
    }
